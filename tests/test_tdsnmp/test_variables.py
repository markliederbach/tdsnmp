...
def test_variables_003_snmp_variable_repr_binary():
    var = SNMPVariable(
        'sysDescr', '0',
        iso_8859_1(chr(20)) + 'my thingo' + iso_8859_1(chr(155)),
        'OCTETSTR'
    )
    assert var.__repr__() == (
...
def test_variables_004_snmp_variable_repr_binary_only():
    var = SNMPVariable(
        'sysDescr', '0',
        iso_8859_1(chr(20)) + iso_8859_1(chr(155)),
        'OCTETSTR'
    )
    assert var.__repr__() == (
...
def test_variables_010_snmp_variable_list():
